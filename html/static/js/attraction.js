...
$(document).on('click', '.attraction-line', function() {
    $.setEditAttraction(this);
});
...
$.setAttractions = function (){
    ...
    $.ajax({
        ...
        headers: {"Authorization": "token"},
        success: function (result) {
            const attractions = result.body;
            const attractionsArea = $("#attractions-area");
            attractionsArea.children("li").remove();
            if (attractions.size){
